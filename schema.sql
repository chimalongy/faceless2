...
-- Multiple LLM accounts with provider account ID, source ('gemini', 'openrouter', 'nvidia'), API token/key, and timestamps.
CREATE TABLE IF NOT EXISTS llm_accounts (
    id SERIAL PRIMARY KEY,
    account_email TEXT NOT NULL,
    source TEXT DEFAULT 'gemini', -- 'gemini', 'openrouter', or 'nvidia'
    account_id TEXT,
...
CREATE TABLE IF NOT EXISTS general_settings (
    ...
    nvidia_base_url TEXT DEFAULT 'https://integrate.api.nvidia.com/v1',
