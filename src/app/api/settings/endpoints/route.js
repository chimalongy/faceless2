...
export async function GET() {
  try {
    ...
    const nvidiaBaseUrl = generalData.nvidiaBaseUrl || "https://integrate.api.nvidia.com/v1";
...
export async function POST(request) {
  try {
    ...
    const nvidiaUrl = (nvidiaBaseUrl || "https://integrate.api.nvidia.com/v1").trim();
    ...
    return NextResponse.json({
      ...
      nvidiaBaseUrl: refreshedGen.nvidiaBaseUrl || nvidiaUrl,
      showShortsTitleOverlay: Boolean(refreshedGen.showShortsTitleOverlay),
